...
Next.js 13+ App Router is the recommended way to use the Saleor Auth SDK with Next.js. It is the easiest to set up and provides the best user experience.
